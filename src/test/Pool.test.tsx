...
describe("Pool Component", () => {
    ...
    const CustomComponent = ({ credits, reverse, circleColor, creditColor, ...props }: { credits: number; reverse: boolean | undefined, circleColor: string | undefined, creditColor: string | undefined }) => {
        return (
            <QuadraticVote.Provider credits={credits} questions={questions}>
                <QuadraticVote.Pool circleColor={circleColor} reverse={reverse} creditColor={creditColor} {...props} />
