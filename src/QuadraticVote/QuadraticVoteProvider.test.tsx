...
import QuadraticVoteProvider from './QuadraticVoteProvider';
...
describe("<QuadraticVoteProvider/>", () => {
    ...
    const wrapper = ({ children }: { children: ReactElement }) => (
        <QuadraticVoteProvider credits={CREDITS} questions={questions}>{children}</QuadraticVoteProvider>
    );
    ...
    it('resets votes correctly', () => {
        ...
        const customWrapper = ({ children }: { children: ReactElement }) => (
            <QuadraticVoteProvider credits={CREDITS} questions={newQuestions}>{children}</QuadraticVoteProvider>
        );

        const { result } = renderHook(() => useQuadraticVote(), { wrapper: customWrapper });
